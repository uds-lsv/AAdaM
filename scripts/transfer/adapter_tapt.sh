...
OUTPUT_DIR=results/track_c/tapt_testset_translate_test/
LANG_ADAPTER_DIR=${PROJECT_DIR}/checkpoints/afro_adapter/lang_adapter/tapt

##amh ary hau kin arq hin arb ind afr pan
for TARGET in amh ary hau kin arq hin arb ind afr pan; do
  for SOURCE in eng; do
    ...
    TASK_ADAPTER_DIR=${PROJECT_DIR}/checkpoints/track_c/ad_tapt
